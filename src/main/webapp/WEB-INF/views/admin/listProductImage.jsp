...
<div class="workingArea">
    ...
    <table class="addPictureTableDiv" align="center">
        <tr>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisSingle}" var="productImage">
                            <tr>
                                ...
                                <td>
                                    <a title="点击查看原图" href="img/ProductImageSingle/${productImage.id}.jpg">
                                        <img height="50px" src="img/ProductImageSingle/${productImage.id}.jpg">
                                    </a>
                                </td>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisDetail}" var="productImage">
                            <tr>
                                <td>${productImage.id}</td>
                                <td>
                                    <a title="点击查看原图" href="img/ProductImageDetail/${productImage.id}.jpg">
                                        <img height="50px" src="img/ProductImageDetail/${productImage.id}.jpg"></a>
                                </td>
                                <td><a deleteLink="true"
                                       href="admin_productImage_delete?id=${productImage.id}"><span
                                        class=" 	glyphicon glyphicon-trash"></span></a></td>
